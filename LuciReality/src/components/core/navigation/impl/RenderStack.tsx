...
import CustomLuciHeader from "./CustomHeader";
 ...
 */
function renderNativeStack(leafStack: LuciStack, hasSidebar: boolean) {
 ...
 */
export const StackWrapper = (leafStack: LuciStack): React.FC => {
...
const EmptyScreen: React.FC = () => {
    return (
        <View style={styles.emptyScreen}>
            <LuciText text={"No item selected"} font={Typography.instance.body}/>
        </View>
    )
}
